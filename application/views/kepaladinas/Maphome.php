...
<script type="text/javascript">
    ...
    var mq=L.tileLayer(mapbox.url,mapbox.options);
		mq.addTo(mymap);
	var baseMaps = {
                "Mapbox Streets": mq,
                "Open Street Map":osm
    ...
    //endbasemap
    //layers
    var kbb="<?php echo base_url('assets/layers/request_kbb.php')?>";
	$.getJSON(kbb,function(kbb){
        var kbb = L.geoJson( kbb,{onEachFeature:popUp, style: warna},
         ).addTo(mymap)
	});
