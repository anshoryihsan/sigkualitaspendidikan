...
<div class="container">
	<ul id="breadcrumbs">
		<li><a href="<?php echo base_url();?>index.php/kepaladinas/home"><i class="icsw16-home"></i></a></li>
	</ul>
</div>
<div class="container">
	<div class="row-fluid">
                ...
                <div class="tab-content w-box-content cnt_a">
                    <div  class="toolbar clearfix">
                        <div class="" id="n_combobox">
                            <form class="" action="<?php echo base_url('index.php/kepaladinas/home/cariMap'); ?>" method="post">
                            <div class="span5">
...
<script type="text/javascript">
    ...
    var kualitasSMP="<?php echo base_url('/assets/layers/mapSMP/layers_kulitas_mapSMP.php')?>";
    var pointsmp="<?php echo base_url('/assets/layers/mapSMP/point_smp.php')?>";
    var pointidentitassmp="<?php echo base_url('/assets/layers/mapSMP/point_identitasSMP.php')?>";
	...
	$.getJSON(kualitasSMP,function(kualitasSMP){
        var kualitasSMP = L.geoJson( kualitasSMP,{onEachFeature:popUp, style: warna}
         ).addTo(mymap);
         controlLayers.addBaseLayer(kualitasSMP, 'Kualitas smp');
    });
    
	$.getJSON(pointsmp,function(pointsmp){
        var pointsmp = L.geoJson( pointsmp,{
            onEachFeature:popUp,
        }
         );
         controlLayers.addOverlay(pointsmp, 'marker smp');
    });

    $.getJSON(pointidentitassmp,function(pointidentitassmp){
        var pointidentitassmp = L.geoJson( pointidentitassmp,{
            onEachFeature:popUp,
        }
         );
         controlLayers.addOverlay(pointidentitassmp, 'marker data identitas smp');
    });
    ...
    $.getJSON(danausungai,function(danausungai){
        var danausungai = L.geoJson( danausungai,{
         ...
         controlLayers.addOverlay(danausungai, 'Danau dan Sungai');
    });
