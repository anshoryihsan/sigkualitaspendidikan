				...
				<div class="container">
					<div id="fade-menu">
						<ul class="clearfix" id="mobile-nav">
							<li>
								<a href="<?php echo site_url(); ?>/kepaladinas/home">Home</a>
							</li>
							<li>
								<a href="<?php echo site_url(); ?>/kepaladinas/Kualitas_pendidikan" class="ptip_s" title="Kulitas Pendidikn">Kulitas Pendidikan</a>
							</li>
						</ul>
					</div>
				</div>
