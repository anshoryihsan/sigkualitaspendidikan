    ...
    <div class="span12">
      <div class="w-box w-box-blue">
        <div class="w-box-header">
          ...
          <form class="pull-right" action="<?php echo base_url('index.php/kepaladinas/Kualitas_pendidikan/cariKualitas'); ?>" method="post">
          ...
          <div class="row-fluid cnt_a invoice_preview"> <!--rowfluid start-->
            <div class="span12">
              <div class="inv_notes">
                ...
                <ul class="list_a">
                  <li>
                    <p class="text-info"> APK (Angka Partisispasi Kasar)</p>
                  </li>
                  <li>
                    <p class="text-info"> APM (Angka Partisispasi Murni)</p>
                  </li>
                </ul>
